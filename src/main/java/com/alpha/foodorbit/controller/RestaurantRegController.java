...
public class RestaurantRegController {
    ...
    private void adding(@RequestBody @Valid RestaurantReqDto restaurantReqDto){
...
//        Restaurant r=restaurantService.findRestaurant(mobno);
    ...
    public ResponseEntity<Restaurant> addtomenu(@RequestBody @Valid Item item, @RequestParam long mobno){
